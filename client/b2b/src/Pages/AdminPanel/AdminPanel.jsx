        ...
        <Row className="py-5">
          ...
          <Col md="6">
            ...
            <Container className={`${styles.profilePhotoWithDetails} px-lg-5`}>
                <Row>
                    <Col>
                        <div className={`${styles.profileWrapper} d-flex justify-content-center align-items-center`}>
                            <div className={styles.editProfilePhoto}>X</div>
                            <img src={image} className={styles.profilePhoto} alt="" />
                        </div>
                    </Col>
                ...
                <Row className="pt-5 pb-4" style={{ borderBottom: '2px solid #F1F1F5' }}>
                    <Col md='6'>
                        <h3>About Me</h3>
                    </Col>
                    <Col md='6'>
                    ...
                    <ul>
                        {
                            aboutMe.map((item) => (
                                <>
                                    <li className="py-2">
                                        <Link className={`${styles.aboutLinks} d-flex align-items-center`} to={item.link}>
                ...
                <Row className="py-lg-5">
                    <Col md='6'>
                        <div className={styles.manageUsers}>
                            <h4 className="pt-2">
                                <FontAwesomeIcon className={`${styles.user} pe-3`} icon={faGlobe} />
                                Manage Users
                            </h4>
                        </div>
                    </Col>
                    <Col md='6' className=" d-flex justify-content-end ">
                        <div className={`${styles.manageWholeSeller}`}>
                            <h4 className="pt-2">
                                <FontAwesomeIcon className={`${styles.manager} pe-3`} icon={faCirclePlay} />
                                Manage Whole Seller
                            </h4>
                        </div>
                    </Col>
